...
class SectionEnableApps(PageBase):
    def __init__(self, driver):
        ...
        self.cmd_and_args_application = (By.XPATH,
                                         '//*[@id="root"]/div/main/section/div/div/div[3]/div/div[2]/div[1]/p[2]')
        self.button_to_save_new_configuration = (By.XPATH,
                                                 '//*[@id="root"]/div/main/section/div[2]/aside/form/div[2]/button[2]')
        # Container for insert new values in container (Edit Container)
        self.container_edit_input_application_name = (By.XPATH,
                                                      '//*[@id="root"]/div/main/section/div[2]/aside/form/div[1]/section/div/label[1]/input')
        self.container_edit_input_command = (By.XPATH,
                                             ' //*[@id="root"]/div/main/section/div[2]/aside/form/div[1]/section/div/label[3]/input')
        self.container_edit_input_arguments = (By.XPATH,
                                               '//*[@id="root"]/div/main/section/div[2]/aside/form/div[1]/section/div/label[4]/input')

    def get_status_without_wait(self):
        element = self.driver.find_element(*self.status_application)
        return element.text

    @allure.step("Waiting the page reload")
    ...
    def check_text_returned_from_element(self):
        return self.text(self.status_application)

    @allure.step("Checking if the text returned is equal the value expect")
    def check_if_text_is_equal_the_expect(self, value):
        return self.text_eq(self.status_application, value)
