...
class TestHomeE2E:
    ...
    @allure.title('Flux of tests E2E - ID: TU01')
    def test_user_creating_new_applications_in_website(self):
        ...
        self.page_home.creating_new_application('Starting java application', '8080', 'C:\Blooms\BloomsKimono\jvApi', 'mvn', 'spring-boot:run')
        ...
        self.page_home.changes_configuration_from_the_container_created('New application', '8080', 'C:\Blooms\BloomsKimono\jvApi', 'spring/boot-run', 'mvl')
        self.page_home.click_in_new_app_add_app_button()
        self.page_home.click_on_start_the_application_created()
        ...
        assert self.page_home.verifying_text_from_alerts_container()